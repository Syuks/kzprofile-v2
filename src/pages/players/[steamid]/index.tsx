...
import { useGameMode, useLocalSettings } from "@/components/localsettings/localsettings-provider"
...
function PlayerProfile() {
  ...
  const playerProfileKZData = usePlayerProfileKZData(steamid, gameMode, localSettings.gokzTop)
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-evenly space-x-2 sm:justify-start">
        <PlayerProfileNavLink path="" end={true} playerProfileKZData={playerProfileKZData.data}>
          <TextAlignLeftIcon className="h-4 w-4 sm:mr-2" />
          <span className="hidden sm:inline">Finishes</span>
        </PlayerProfileNavLink>
        <PlayerProfileNavLink path="unfinishes" playerProfileKZData={playerProfileKZData.data}>
          <StopwatchIcon className="h-4 w-4 sm:mr-2" />
          <span className="hidden sm:inline">Unfinishes</span>
        </PlayerProfileNavLink>
        <PlayerProfileNavLink path="jumpstats" playerProfileKZData={playerProfileKZData.data}>
        ...
        <PlayerProfileNavLink path="achievements" playerProfileKZData={playerProfileKZData.data}>
