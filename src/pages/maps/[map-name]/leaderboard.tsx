  ...
  return (
    <>
      ...
      <div className="mb-24">
            ...
            {selectedFilters.time.show && (
              <div className="mr-4 mt-4">
                <DatatableFacetedMinMaxFilter
                  ...
                  title="Time"
                  numberFormater={(value) => (value ? getTimeString(value) : getTimeString(0))}
                />
              </div>
            )}
            {selectedFilters.points.show && (
              <div className="mr-4 mt-4">
                <DatatableFacetedMinMaxFilter column={table.getColumn("points")} title="Points" />
              </div>
            )}
            {selectedFilters.teleports.show && (
              <div className="mr-4 mt-4">
                <DatatableFacetedMinMaxFilter column={table.getColumn("teleports")} title="TPs" />
              </div>
            )}
        ...
        <DataTable table={table} columns={columns} loading={mapTimesInfiniteQuery.isFetching} />
        <DataTablePagination
          table={table}
