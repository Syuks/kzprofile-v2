...
import AdminMapGrid from "./admin-map-grid"
...
function Admin() {
    useEffect(() => {
        document.title = "Admin - KZ Profile"
    }, [])

    const kzProfileMapsQuery = useKZProfileMaps()

    const [openDialog, setOpenDialog] = useState(false)
    const [dialogMap, setDialogMap] = useState<KZProfileMap | undefined>(undefined)
        ...
        <div className="py-10">
            <div className="flex justify-between">
                ...
                <div className="flex space-x-2">
                    ...
                    <Button
                        size="icon"
                        onClick={() => {
                            navigator.clipboard.writeText(JSON.stringify(kzProfileMapsQuery.data))
            ...
            <div className="mb-24">
                ...
                <div className="flex flex-wrap justify-center">
                    <AdminMapGrid
                        table={table}
                        isLoading={kzProfileMapsQuery.isLoading}
            ...
            <AdminDialog open={openDialog} onOpenChange={setOpenDialog} dialogMap={dialogMap} />
        </div>
    )
}
